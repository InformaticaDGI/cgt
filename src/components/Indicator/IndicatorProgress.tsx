...
const IndicatorProgress = ({ value, size = 180, strokeWidth = 10, textSize = 20, backgroundColor = "#F3F4F6" }: { value: number, size?: number, strokeWidth?: number, textSize?: number, backgroundColor?: string }) => {
