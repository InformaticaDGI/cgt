            ...
            <GridItem $colSpan={12}>
                <FormControl label="Fecha de inicio" required>
                    <$Input type="date" name="initialDate" placeholder="Fecha de inicio"
                        value={formik.values.initialDate} onChange={(e: React.ChangeEvent<HTMLInputElement>) => formik.setFieldValue('initialDate', e.target.value)}
                        onBlur={formik.handleBlur}
                    />
                </FormControl>
            </GridItem>
            <GridItem $colSpan={12}>
                <FormControl label="Fecha de fin" required>
                    <$Input type="date" name="endDate" placeholder="Fecha de fin"
                        value={formik.values.endDate} onChange={(e: React.ChangeEvent<HTMLInputElement>) => formik.setFieldValue('endDate', e.target.value)}
                        onBlur={formik.handleBlur}
                    />
                </FormControl>
            </GridItem>
            <GridItem $colSpan={24}>
                <FormControl label="Descripción">
                    <$TextArea name="observations" placeholder="Descripción"
                        value={formik.values.observations} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => formik.setFieldValue('observations', e.target.value)}
                        onBlur={formik.handleBlur}
                    />
                </FormControl>
            </GridItem>
