    ...
    return <Navigation>
        <MainWrapper>
            ...
            <Card isSelectable={false}>
                <CardHeader>
                    <Text style={{ fontSize: '14px', color: '#0C777C', fontWeight: '700', textWrap: 'nowrap' }}>Programa Ejemplo 1</Text>
                    <Flex direction="row" justify="end" align="center" gap="8px">
                        <Text style={{ fontSize: '14px', color: '#889C9D', fontWeight: 'normal', textWrap: 'nowrap', textAlign: 'justify' }}>{"21 Proyectos"}</Text>
