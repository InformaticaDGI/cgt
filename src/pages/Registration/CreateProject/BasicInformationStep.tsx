...
const BasicInformation = () => {
  ...
  const validate = (values: any) => {
    ...
    if (!values.initialDate)
      errors.initialDate = "La fecha de inicio es requerida";
    ...
    if (!values.parentId)
      errors.parentId = "La secretaría territorial es requerida";
        ...
        <Grid $columns="repeat(24, 1fr)" $gap="12px" $width="100%">
          ...
          <GridItem $colSpan={24}>
            <FormControl
              ...
              required
              error={
                formik.errors.programId && formik.touched.programId
          ...
          <GridItem $colSpan={12}>
            <FormControl
              ...
              required
              error={
                formik.errors.initialDate && formik.touched.initialDate
            ...
            >
              <Input
                ...
                onChange={(e) =>
                  formik.setFieldValue("initialDate", e.target.value)
                }
                onBlur={formik.handleBlur}
              />
            </FormControl>
          ...
          <GridItem $colSpan={12}>
            ...
            >
              <Input
                ...
                onChange={(e) =>
                  formik.setFieldValue("finalDate", e.target.value)
                }
                onBlur={formik.handleBlur}
              />
            </FormControl>
            ...
            <FormControl
              ...
              error={
                formik.errors.areaId && formik.touched.areaId
                  ? (formik.errors.areaId as string)
                  : undefined
              }
            >
              <AreaMultiSelect
